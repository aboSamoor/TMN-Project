...
\begin{centering}
    ...
    \texttt{nikhil.m} & 305 & Disco Wikipedia \\ \hline
    \texttt{rami.m} & 600 & Disco Wikipedia \\ \hline
    \end{tabular}
\end{centering}
\bigskip
...
Our results are very promising. We are able to successfully label.
  ...
  \begin{figure*}[h]
    ...
    \caption{A pictorial representation of the \texttt{bill.mat}
      ...
      similar the queries are. The query class is displayed along the
      ...
      cluster, however has 10 user queries and 0 TrackMeNot queries.}
    \label{fig:disco.bill}
  \end{figure*}

  \begin{figure*}[h]
    \centering
    \includegraphics[width=\linewidth]{disco_rami_305}
    \caption{A pictorial representation of the \texttt{rami.mat}
      ...
      TrackMeNot. If $(i,i)$ is blue, then the query is genuine. We
      see that many queries are semantically unrelated. The largest
      cluster, however has 13 user queries and 2 TrackMeNot queries.}
  ...
  \begin{figure*}[h]
    \centering
    \includegraphics[width=\linewidth]{disco_nikhil_600}
    \caption{A pictorial representation of the \texttt{nikhil.mat}
      ...
      TrackMeNot. If $(i,i)$ is blue, then the query is genuine. We
      see that many queries are semantically unrelated. The largest
      cluster, however has 4 user queries and 9 TrackMeNot queries.}
